...
$inspur_ord = mysqli_query($connect, "INSERT INTO rt_cart(id,uname,pid,status,rdate,price,category,quantity,amount,pname,retailer) VALUES('$id','$uname','$pid','0','$rdate','".$prow['price']."','$category','".$cals['quantity']."','$amount','".$prow['product']."','".$prow['retailer']."')");
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">Digital</span>
                    <span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Farming</span>
                </a>
            </div>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="/purchase" class="nav-item nav-link">Purchased</a>
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <a href="" class="btn px-0 ml-3">
                                ...
                                <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;">{{cart_n}}</span>
                            </a>
                        </div>
                    </div>
                </nav>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    <a class="breadcrumb-item text-dark" href="/userhome">Home</a>
            ...
            <div class="col-lg-8 table-responsive mb-5">
                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><a href="/cart?act=del&did={{rs[0]}}" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a></td>
                        </tr>
				...
				{% if act=="mail" %}
					...
					{% if st=="1" %}
					 ...
					 <iframe src="http://iotcloud.co.in/testmail/testmail1.php?message={{rs2[0]}}&email={{rs2[1]}}&subject=Product Required" width="10" height="10" frameborder="1"></iframe>
...
setTimeout(function () {
   ...
   window.location.href= '/cart?act=buy';
}, 3000);
</script>-->
						{% endif %}
                        ...
                        <button type="submit" class="btn btn-block btn-primary font-weight-bold my-3 py-3">Confirm</button>
						</form>
						{% else %}
						<form name="form2" method="post" action="">
						<input type="hidden" name="ch" value="2">
						<input type="text" name="card" class="form-control" placeholder="Card No." required>
                        <button type="submit" class="btn btn-block btn-primary font-weight-bold my-3 py-3">Buy Now</button>
						</form>
						{% endif %}
