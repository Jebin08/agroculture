...
$qry=mysqli_query($connect,"select * from rt_cart where uname='$uname' and status='1'");
                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><?php echo $row['uqut'];?></td>
                            <td class="align-middle"><?php echo $row['amount'];?></td>
                            <td>
							<?php
							if($row['d_status']=="1")
							{
							echo '<span style="color:green">[Home Delivered]</span>';
							}
							else
							{
								if($row['d_status']=='2')
								{
								echo '<span style="color:#FF0000">[Form Shopping]</span>';
								}
							}
							?>
							</td>
                            <td class="align-middle">
								<a href="purchase.php?act=del&id=<?php echo $row['id']; ?>">Cancel</a>
							...
							{
                                ?>
								<a href="review.php?rid=<?php echo $row['id']; ?>&pid=<?php echo $row['pid'];?>">Review</a>
...
{
    $id=$_REQUEST['id'];
mysqli_query($connect,"delete from rt_cart where id='$id'");
?>
