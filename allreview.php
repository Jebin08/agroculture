...
$q1=mysqli_query($connect,"select * from rt_review where uname='$uname'");
$r1=mysqli_fetch_array($q1);

$qry=mysqli_query($connect,"select * from rt_review where pid='$pid' and status='1'");
?>
<html>
                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><?php echo $row['review']; ?></td>
                            <td class="align-middle"><?php echo $row['rdate']; ?></td>
