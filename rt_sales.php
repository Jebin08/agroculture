...
$qry=mysqli_query($connect,"select * from rt_cart where retailer='$uname'");
?>
<html>
                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><?php echo $row['pid']; ?>
                                <?php
							
							if($row['status']=="1" and $row['quantity']=='0')
							{
                                ?>
                                <?php
							...
							else
							{
								if($row['status']=='1')
								{
								echo '<span style="color:#FF0000">[required '.$row['quantity'].']</span>';
								}
							}
							?>
							</td>
							...
							<td class="align-middle">
								...
								<a href="rt_sales.php?act=go&deid=<?php echo $row['id']; ?>">Go Farm</a>
...
?>
    ...
    <?php
     ...
     $i=mysqli_query($connect,"select * from rt_cart where d_status='1'");
...
?>  
                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><?php echo $r1['quantity'];
							
							if($r1['status']=="1" and $r1['quantity']=='0')
							{
							echo '<span style="color:#FF0000">[Low]</span>';
							}
							else
							{
								if($r1['status']=='1')
								{
								echo '<span style="color:#FF0000">[required '.$r1['quantity'].']</span>';
								}
							}
							?>
							</td>
    ...
    <?php
     ...
     $i=mysqli_query($connect,"select * from rt_cart where d_status='2'");
   if(mysqli_num_rows($i)>0){
