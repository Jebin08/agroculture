                        ...
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Agriculture Products</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Organically produced agricultural products are good for human health, so come to farmers and do business digitally.</p>
            ...
            <div class="col-lg-4">
                <div class="product-offer mb-30" style="height: 200px;">
                    ...
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">Agri</h6>
                        <h3 class="text-white mb-3">Agroculture</h3>
        ...
        <div class="row px-xl-5">
            <div class="col-md-6">
                <div class="product-offer mb-30" style="height: 300px;">
                    ...
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">Agri</h6>
                        <h3 class="text-white mb-3">Digital Farming</h3>
                        <a href="" class="btn btn-primary">Sale</a>
                    </div>
                </div>
            </div>
