...
if(isset($btn))
{
	 $mq=mysqli_query($connect,"select max(id) from rt_retailer");
	 ...
	 $ins=mysqli_query($connect,"insert into rt_retailer(id,name,address,city,mobile,email,proof,uname,pass,create_date) values($id,'$name','$address','$city','$mobile','$email','$proof','$uname','$pass','$rdate')");
	 if($ins)
	 {
	 $msg="ok";
	 }
...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="login.php" class="nav-item nav-link">Farmer</a>
                            <a href="login_cus.php" class="nav-item nav-link">Customer</a>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active"><a href="/register">Signup</a></span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <!-- Contact Start -->
    <div class="container-fluid">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Farmer - Signup</span></h2>
        <div class="row px-xl-5">
