...
extract($_REQUEST);
	if(isset($btn))
	{
		$q1=mysqli_query($connect,"select * from rt_retailer where uname='$uname' && pass='$pass' && status=1");
			$n1=mysqli_num_rows($q1);
				if($n1==1)
				{
				$_SESSION['uname']=$uname;
				header("location:rt_home.php");
				}
				else
				{
...
<body>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active"><a href="reg_retailer.php">Register New</a></span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <!-- Contact Start -->
    <div class="container-fluid">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Farmer Login</span></h2>
        <div class="row px-xl-5">
