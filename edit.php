...
$qry=mysqli_query($connect,"select * from rt_product where id='$pid'");
$row=mysqli_fetch_array($qry);

if(isset($btn))
{
mysqli_query($connect,"update rt_product set product='$product',quantity='$qty',price='$price',details='$details' where id=$pid");
?>
                    ...
                    <form name="form1" method="post">
						<div class="row">
							...
							<div class="col-md-6 form-group">
								<label>Product</label>
								<input class="form-control" type="text" name="product" value="<?php echo $row['product']; ?>" required>
							</div>
							<div class="col-md-6 form-group">
								<label>Price</label>
							...
							<div class="col-md-6 form-group">
								...
								<input class="form-control" type="text" name="details" value="<?php echo $row['details']; ?>" required>
							</div>
                        ...
                        <p></p>
                        <div>
                            <button class="btn btn-primary py-2 px-4" type="submit" name="btn">Update</button>
                        </div>
                    </form>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-4">Retail inventory management is the process of ensuring you carry merchandise that shoppers want, with neither too little nor too much on hand.</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Multi Shop, Tamilnadu, India</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>info@multishop.com</p>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-secondary mb-2" href="/rt_home"><i class="fa fa-angle-right mr-2"></i>Home</a>
